...
- Render the header's right side as Telegram, WhatsApp, authoritative nonterminal goals, authoritative nonterminal tasks, live jobs, and retained logs. Poll durable counts through shared owner state, keep bounded census diagnostics out of the header, and choose singular labels only for an exact uncompressed count of one.
