...
- Every directory containing a tracked or non-ignored untracked file requires a local `AGENTS.md`; there are no generated, testdata, vendor-like, or license-only exceptions.
